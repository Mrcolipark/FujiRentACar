...
const env = {
  ...
  WEBSITE_NAME: String(import.meta.env.VITE_BC_WEBSITE_NAME || 'FUJI RENT A CAR'),
  ...
  BASE_CURRENCY: String(import.meta.env.VITE_BC_BASE_CURRENCY || 'JPY'),
  CURRENCIES,
  ...
  EMAILJS_ENABLED: (import.meta.env.VITE_BC_EMAILJS_ENABLED && import.meta.env.VITE_BC_EMAILJS_ENABLED.toLowerCase()) === 'true',
  ...
  LINE_URL: String(import.meta.env.VITE_BC_LINE_URL || 'https://line.me/R/ti/p/Jpe28k3dZJ'),
  FACEBOOK_URL: String(import.meta.env.VITE_BC_FACEBOOK_URL || ''),
  INSTAGRAM_URL: String(import.meta.env.VITE_BC_INSTAGRAM_URL || ''),
  WECHAT_ID: String(import.meta.env.VITE_BC_WECHAT_ID || ''),
