...
These terms are governed by the laws of Japan.
  ...
  zh: {
    TITLE: '使用條款及租赁条件',
    TOS: `
感谢您選擇 FUJI RENT A CAR（東京國際株式會社）。使用本服務前，請仔细阅读以下條款。
...
• 人身傷害：无限额
• 财產损失：无限额（免赔额：5万日元）
• 車輛损失：最高至市价（免赔额：根据車型5-10万日元）
• 人身意外：最高3000万日元

2.1 碰撞损失免责险（CDW）
每日：1,200-2,000日元（根据車型不同）
购買后可免除事故时的免赔额（5-10万日元）。

2.2 盗窃保护险（TP）
每日：800-1,500日元（根据車型不同）
购買后可免除車輛被盗时的免赔额。

2.3 全方位保障险
每日：2,000-3,500日元（根据車型不同）
• 免赔额為零
• 24小时道路救援
• 轮胎及轮毂保障
• 钥匙遗失保障
